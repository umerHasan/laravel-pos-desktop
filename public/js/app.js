$(document).ready(function() {
    ...
    $(document).on('click', 'button.edit_device_button', function() {
        $('div.device_modal').load($(this).data('href'), function() {
            $(this).modal('show');

            $('form#device_edit_form').submit(function(e) {
                e.preventDefault();
                var form = $(this);
                var data = form.serialize();
    ...
    $(document).on('submit', 'form#device_add_form', function (e) {
        e.preventDefault();
        var form = $(this);
        var data = form.serialize();
