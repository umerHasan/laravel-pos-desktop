                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if($variation->sell_price_inc_tax != $value[2]){
						...
						if (							
							...
							isset($variation->product->esl_device_code)							
						) {	

                            \Log::info('sending product update to esl');
																													
							$response2 = Http::withToken(auth()->user()->esl_token)
							->withHeaders([
								'Content-Type' => 'application/json',
							])
							->post('https://api.pfa.com/RetailEsls/RetailEslBind', [
								'retailShopCode' => auth()->user()->shop_code,
								'binds' => [
									[
