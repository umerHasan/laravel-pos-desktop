...
<section class="content-header">
    <!-- <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang( 'tax_rate.tax_rates' ) -->
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black"> Device
        <!-- <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">@lang( 'tax_rate.manage_your_tax_rates' )</small> -->
         <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">Manage your device</small>
    </h1>
</section>
...
<section class="content">    
     @component('components.widget', ['class' => 'box-primary', 'title' => 'All your devices'])
        @can('tax_rate.create')
            @slot('tool')
                <div class="box-tools">
                    <button class="tw-dw-btn tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-white tw-border-none tw-rounded-full btn-modal pull-right"
                        data-href="{{action([\App\Http\Controllers\DeviceController::class, 'create'])}}" 
                        data-container=".device_modal">
    ...
    <div class="modal fade device_modal" tabindex="-1" role="dialog" 
