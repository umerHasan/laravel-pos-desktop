...
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_1' ) {{ 'hide' }} @endif" data-type="custom_pay_1" >
	<div class="col-md-12">
		<div class="form-group">
			<input type="hidden" id="cardknox_device_alt" value="{{ $register_details->device_id }}">
			<button type="button" class="btn btn-primary" id="proceed_payment_alt">Proceed to Payment</button>
		</div>
	</div>
</div>
