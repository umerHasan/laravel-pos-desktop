    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="flex justify-content-between align-items-center">
                                ...
                                <button type="button" class="btn btn-primary add-payment-custom" data-value="1"><span class="display_currency" data-currency_symbol="true">1</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="5"><span class="display_currency" data-currency_symbol="true">5</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="10"><span class="display_currency" data-currency_symbol="true">10</span></button>

                                <button type="button" class="btn btn-primary  add-payment-custom" data-value="20"><span class="display_currency" data-currency_symbol="true">20</span></button>

                                <button type="button" class="btn btn-primary add-payment-custom" data-value="50"><span class="display_currency" data-currency_symbol="true">50</span></button>

                                <button type="button" class="btn btn-primary add-payment-custom" data-value="100"><span class="display_currency" data-currency_symbol="true">100</span></button>
            ...
            <div class="modal-footer">
                ...
                <!-- <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="cardknox-pay-alt" style="display: none;">Pay with Cardknox</button> -->
