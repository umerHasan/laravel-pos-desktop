...
<div class="form-group col-md-6">
    {!! Form::label('esl_token', __( 'lang_v1.esl_token') . ':') !!}
    @show_tooltip(__('lang_v1.esl_token'))
    {!! Form::text('esl_token', !empty($user->esl_token) ? $user->esl_token : null, ['class' => 'form-control', 'id' => 'esl_token', 'placeholder' => __( 'lang_v1.esl_token') ]); !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('shop_code', __( 'Shop code') . ':') !!}
    @show_tooltip(__('Shop code'))
    {!! Form::text('shop_code', !empty($user->shop_code) ? $user->shop_code : null, ['class' => 'form-control', 'id' => 'shop_code', 'placeholder' => __( 'Shop code') ]) !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('esl_signature_code', __( 'lang_v1.esl_signature_code') . ':') !!}
    @show_tooltip(__('lang_v1.esl_signature_code'))
    {!! Form::text('esl_signature_code', !empty($user->esl_signature_code) ? $user->esl_signature_code : null, ['class' => 'form-control', 'id' => 'esl_signature_code', 'placeholder' => __( 'lang_v1.esl_signature_code') ]); !!}
</div>
<div class="form-group col-md-3">
    {!! Form::label('store_code', __( 'Store code') . ':') !!}
    @show_tooltip(__('Store code'))
    {!! Form::text('store_code', !empty($user->store_code) ? $user->store_code : null, ['class' => 'form-control', 'id' => 'store_code', 'placeholder' => __( 'Store code') ]) !!}
</div>