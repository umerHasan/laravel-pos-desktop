...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '#notforsell-selected', function(e) {
                e.preventDefault();
                var selected_rows = getSelectedRows();
                ...
                if (selected_rows.length > 0) {
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            var form = $('form#mass_notforsell_form')
            ...
            $(document).on('click', '#forsell-selected', function(e) {
                e.preventDefault();
                var selected_rows = getSelectedRows();
                ...
                if (selected_rows.length > 0) {
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            var form = $('form#mass_forsell_form')
